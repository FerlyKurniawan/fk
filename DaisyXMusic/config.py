...
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "Channelrumah")
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "alivesholarssociety")
PROJECT_NAME = getenv("PROJECT_NAME", "Ferly-Project")
